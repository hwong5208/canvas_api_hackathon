...
div.innerHTML =
"<h4>Deadline Reminder Setup:</h4><p style = 'font-size =10pt'>Please enter your phone number:</P><input type='Cellphone'id='phoneInput' name='phonenumber' style='height:20px;font-size:10pt;width:120px'/></n><button id='submit_button' >Submit</button><button id='demo_button'>Demo</button>";
